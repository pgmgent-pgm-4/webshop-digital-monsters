...
import { CreateOptions, FindOptions, Model, ModelCtor, SaveOptions } from 'sequelize/types/lib/model';
import { Association, AssociationOptions, SingleAssociationAccessors } from 'sequelize/types/lib/associations/base';
